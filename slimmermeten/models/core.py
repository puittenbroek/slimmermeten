...
class ElektricityReading(models.Model):
    ...
    t1_reading = models.DecimalField(default=0,max_digits=12, decimal_places=2) #23:00-07:00
    t1_back_reading = models.DecimalField(default=0,max_digits=12, decimal_places=2) #23:00-07:00

    # T2 standen (normal + back to grid)
    t2_reading = models.DecimalField(default=0,max_digits=12, decimal_places=2) #07:00-23:00
    t2_back_reading = models.DecimalField(default=0,max_digits=12, decimal_places=2) #07:00-23:00
